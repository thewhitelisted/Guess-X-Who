...
public class Game {
    ...
    public static void cardClick(MouseEvent e) {
        ...
        index = row * 5 + column;
        // If card is already flipped, it will set the flipped boolean to be false to
        // indicate that the card is not flipped
    ...
    public static String guessClick(MouseEvent e) {
        ...
        // When you click on a card, return the name of the character that you clicked
        // on
    ...
    public static String[] infoClick(MouseEvent e) {
        ...
        int row = (MouseY - 20) / 140;
        int index = row * 5 + column;
        // When you click on a card, return the data based on the 10 features of the
        // character that you clicked on
        if (index >= 0 && index < Main.game_panel.characters.length && Main.game_panel.characters[index] != null) {
